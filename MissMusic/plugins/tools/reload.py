...
from MissMusic.utils.database import get_authuser_names, get_cmode
from MissMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MissMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Miss.stop_stream(message.chat.id)
    except:
        pass
