...
import config
from MissMusic import Carbon, YouTube, app
from MissMusic.core.call import Miss
from MissMusic.misc import db
from MissMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from MissMusic.utils.exceptions import AssistantErr
from MissMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from MissMusic.utils.inline.playlist import close_markup
from MissMusic.utils.pastebin import Missbin
from MissMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Miss.force_stop_stream(chat_id)
